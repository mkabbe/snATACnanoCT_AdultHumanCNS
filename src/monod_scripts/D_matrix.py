...
peaks = "data/peaks/210510_merged_louvain_cluster_peaks.bed"  ## pre-sorted
genes = "ref/gene_promoters.bed"    ## 2kb promoter centred on TSS
peak_dict = {}
gene_dict = {}
...
np.save("ref/210607_D_matrix", D)
#save_npz("ref/210607_D_matrix.npz", D)
