...
CSV = SAMPLE_PATH + "singlecell_EPI.csv"

SLOP_TSS = "/data/proj/GCB_MK/CZI/episcanpy_analysis/AGG_ATAC_210218/slop_tss.bed"
LEFT_FLANK = "/data/proj/GCB_MK/CZI/episcanpy_analysis/AGG_ATAC_210218/lflank_tss.bed"
RIGHT_FLANK = "/data/proj/GCB_MK/CZI/episcanpy_analysis/AGG_ATAC_210218/rflank_tss.bed"
...
## write to csv file 
adata.obs.to_csv(OUT_PATH+ sys.argv[1] + "_TSS_obs.csv", header=True, index_label=False)
...
plt.savefig(OUT_PATH+ sys.argv[1] + "_TSSvFrag_QC_plot.pdf")
